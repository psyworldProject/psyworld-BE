...
routes.put('/:id/comment/:commentId', AuthMiddleware.verifyToken, PhotobookController.createComment);
routes.delete('/:id/comment/:commentId', AuthMiddleware.verifyToken, PhotobookController.createComment);
